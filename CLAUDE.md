...
- `src/cmd/` — CLI commands (root, matrix, bench, lint, install, update, version, release, npm-publish, ignore/unignore, cacheprog) using Cobra; also includes dependabot (automatic dependency graph submission to GitHub in CI)
