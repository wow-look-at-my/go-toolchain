...
tests:
	...
	# The OUTCOME repeats, never the sentence. A host that registers as it
	# starts says "is registered" and then "is already registered", which is
	# the same outcome reached again.
