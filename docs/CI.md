...
The section above builds the test binaries for the host. So inside a test, `os` answers as a native Windows program. While every earlier phase of the same job was the APE answering cosmo's POSIX. directories differ. Each one broke a test:
