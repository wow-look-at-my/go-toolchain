...
// claudeProcessAncestor is a no-op on platforms without /proc (native darwin
// and windows builds). Detection there falls back to the CLAUDECODE
// environment marker in runningUnderClaude.
