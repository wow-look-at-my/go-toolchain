...
func TestBinaryName(t *testing.T) {
	...
	// The cosmo fat APE is the plain name (a single file covers every platform) and gets no .exe despite being a PE polyglot.
...
func TestUnpublishableWasmName(t *testing.T) {
	// The opt-out shape: the .wasm suffix keeps the artifact out of the upload set.
